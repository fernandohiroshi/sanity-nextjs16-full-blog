...
export const recentArticles: ArticleCard[] = [
  {
    ...
    excerpt:
      'Um passeio pelas trilhas e mirantes do entorno do Parque Nacional do Iguaçu com foco em turismo consciente e preservação.',
    postType: 'normal',
  },
  {
    category: 'Evento',
    ...
    excerpt:
      'Uma seleção de eventos noturnos que mostram a cultura, a música e a arte na tríplice fronteira.',
    postType: 'normal',
  },
  {
    category: 'Gastronomia',
...
export const eventArticles: ArticleCard[] = [
  {
    category: 'Evento',
    ...
    excerpt:
      'Um encontro ao pôr do sol às margens do Rio Iguaçu para apreciar a paisagem e fazer novas conexões.',
    postType: 'event',
  },
  {
    category: 'Gastronomia',
    ...
    excerpt:
      'Uma sequência de experiências gastronômicas que misturam Brasil, Paraguai e Argentina na mesma mesa.',
    postType: 'event',
  },
  {
    category: 'Evento',
    ...
    excerpt:
      'Um passeio guiado pelas ruas históricas de Foz do Iguaçu para conhecer histórias e personagens da cidade.',
    postType: 'event',
  },
  {
    category: 'Gastronomia',
    ...
    excerpt:
      'Um evento intimista para provar pratos típicos da região com foco em encontros familiares e afetivos.',
    postType: 'event',
  },
]
